	...
	set whois(author) "ArraY"	

	# Version History
	# 0.1      - Made a start, first expermimental test.
	# 0.2-0.5  - Finished some more code
	# 0.6-0.8  - The script was fully functional
	# 0.9      - Removed some silly crap that didnt work for Dalnet anyhow (shows which server he was on)
	# 1.0      - Cleaned some of the code, and it works fine on Dalnet, It also shows idle time and signon time now.
