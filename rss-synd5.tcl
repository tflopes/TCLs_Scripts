...
namespace eval ::rss-synd {
	...
	set rss(abola) {
		...
		"channels"		""
		"database"		"./scripts/feeds/abola.db"
		"output"		"\[\002@@channel!title@@\002\] @@item!title@@ - @@item!guid@@"
		"trigger"		"!rssabola"
	}

	set rss(expresso) {
		"url"			"http://aeiou.expresso.pt/static/rss/atualidade_23412.xml"
		"channels"		""
		"database"		"./scripts/feeds/expresso.db"
		"trigger"		"!rssexpresso"
	}

        
        set rss(palmelanews) {
		"url"			"http://host.tuxsp.eu/rss_palmela.xml"
		"channels"		""
		"database"		"./scripts/feeds/palmelanews.db"
		"trigger"		"!rsspalmela"
        }
	...
	set rss(linuxtoday) {
		...
		"channels"		""
		"database"		"./scripts/feeds/linuxtoday.db"
		"trigger"		"!rsslinuxtoday"
        }
	...
	set rss(Slashdot) {
        ...
        set rss(pretrance) {
		"url"			"http://predb.me/?genre=psychedelic&rss=1"
		"channels"		""
		"database"		"./scripts/feeds/pretrance.db"
		"trigger"		"!rsspretrance"
        }

	set rss(pregoatrance) {
		"url"			"http://predb.me/?genre=goa&rss=1"
		"channels"		""
		"database"		"./scripts/feeds/pregoatrance.db"
		"trigger"		"!rsspregoatrance"
        }

	set rss(pregoatrance1) {
		"url"			"http://predb.me/?genre=psychadelic&rss=1"
		"channels"		""
		"database"		"./scripts/feeds/pregoatrance1.db"
		"trigger"		"!rsspregoatrance1"
        }

	set rss(goatrance) {
		"url"			"http://www.goatrance.de/goabase/party_rss.php?lang=en&saAtt[country]=Portugal"
		"channels"		""
		"database"		"./scripts/feeds/goatrance.db"
		"trigger"		"!rssgoatrance"
        }
